...
var global_txtPublicIdentity = 'sip:'+global_txtPrivateIdentity+'@www.kekocity2.com';
var global_txtRealm = 'www.kekocity2.com';

var global_voipwebsocketserver = 'wss://www.kekocity2.com:8089/ws';
var global_iceservers = '[]';
        var bDisableVideo = 'disabled'; // true o false
        
var global_debuglevel = 'error';

var global_sip_outboundproxy_url = null;
var global_enable_rtcweb_breaker = false;
var global_early_ims = false;
var global_enable_media_caching = false;
var global_disable_callbtn_options = false


                function spatrixnewcall(){
kajax({
url: 'https://spanads.com/e14/incs/apivoip.php',
data: 'op=calldesdewebphone&to='+document.getElementById('typesip').value+'_'+document.getElementById('phonetocall').value+'&from='+global_txtPrivateIdentity+'&lang='+global_lang+'&pass='+global_password+'&callernumber='+global_displayname,
type: 'get',
success: function(){
...
if(a.type == 'get' || a.type == 'GET'){
    ...
    xmlhttp.send(a.data);
        ...
        window.onload = function () {
            ...
            // set debug level
            SIPml.setDebugLevel(global_debuglevel);
            ...
            var preInit = function () {
                ...
                //console.log('preinit sipRegister()');
                sipRegister();
            }
        ...
        function sipRegister() {
            ...
            try {
                ...
                oSipStack = new SIPml.Stack({
                    realm: global_txtRealm,
                    impi: global_txtPrivateIdentity,
                    impu: global_txtPublicIdentity,
                    password: global_password,
                    display_name: global_displayname,
                    websocket_proxy_url: global_voipwebsocketserver,
                    outbound_proxy_url: global_sip_outboundproxy_url ,
                    ice_servers: global_iceservers,
                    enable_rtcweb_breaker: global_enable_rtcweb_breaker,
                    events_listener: { events: '*', listener: onSipEventStack },
                    enable_early_ims: global_early_ims, // Must be true unless you're using a real IMS network
                    enable_media_stream_cache: global_enable_media_caching,
        ...
        function sipCall(s_type) {
            if (oSipStack && !oSipSessionCall) {// && !tsk_string_is_null_or_empty(txtPhoneNumber.value)
                ...
                // make call
                var NUNCA = 'NEVERRR';
                if (NUNCA=='NEVER') {//oSipSessionCall.call(txtPhoneNumber.value) != 0
        ...
        function uiBtnCallSetText(s_text) {
            switch (s_text) {
                case "Call":
                    {
                        var bDisableCallBtnOptions = global_disable_callbtn_options;
                ...
                case 'i_new_call':
                    {
                        if (oSipSessionCall) {
                            ...
                            callback_onstartcall(sRemoteNumber);
